  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        setForm({ name: "", email: "", phone: "", company: productName, insuranceCo: "" });
      }
    } catch (error) {
      console.error(error);
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-6">
        <h2 className="text-3xl font-bold mb-6" style={{ color: "#007847" /* Old Mutual green */ }}>
        ...
        >
          ...
          <input
            ...
            required
            className="w-full p-2 mb-4 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-green-700"
          />

          <label className="block mb-1 font-semibold text-green-800">Email</label>
          <input
            type="email"
            name="email"
            value={form.email}
          ...
          <label className="block mb-1 font-semibold text-green-800">Phone No</label>
          <input
            type="tel"
            name="phone"
            value={form.phone}
          ...
          <label className="block mb-1 font-semibold text-green-800">Insurance Company</label>
          <select
            name="insuranceCo"
            value={form.insuranceCo}
            onChange={handleChange}
            required
            className="w-full p-2 mb-6 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-green-700"
          >
